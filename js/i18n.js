...
export const TRANSLATIONS = {
  en: {
    ...
    showElemLabelsBtn: '📏 Members',
    showElemLabelsTooltip: 'Toggle Member ID and length labels (E1, Lengths...)',
    toastElemLabelsOn: '📏 Member labels: SHOWN',
    toastElemLabelsOff: '📏 Member labels: HIDDEN',
  ...
  pl: {
    ...
    showElemLabelsBtn: '📏 Pręty',
    showElemLabelsTooltip: 'Pokaż/Ukryj oznaczenia i długości prętów (E1, Długości...)',
    toastElemLabelsOn: '📏 Oznaczenia prętów: WIDOCZNE',
    toastElemLabelsOff: '📏 Oznaczenia prętów: UKRYTE',
