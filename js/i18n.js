...
export const TRANSLATIONS = {
  en: {
    ...
    forceFxLabel: 'Horizontal Force Fx [kN]',
    forceFzLabel: 'Vertical Force Fz [kN]',
    momentMLabel: 'Concentrated Moment M [kNm]',
    targetElemLabel: 'Target Member',
    distQxLabel: 'Horizontal Distributed Load qx [kN/m]',
    distQzLabel: 'Vertical Distributed Load qz [kN/m]',
    cancelBtn: 'Cancel',
  ...
  pl: {
    ...
    forceFxLabel: 'Siła pozioma Fx [kN]',
    forceFzLabel: 'Siła pionowa Fz [kN]',
    momentMLabel: 'Moment skupiony M [kNm]',
    targetElemLabel: 'Pręt docelowy',
    distQxLabel: 'Obciążenie poziome qx [kN/m]',
    distQzLabel: 'Obciążenie pionowe qz [kN/m]',
    cancelBtn: 'Anuluj',
    ...
    coordSystemLabel: 'x -> (w prawo), z ^ (w górę)',
