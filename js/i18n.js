...
export const TRANSLATIONS = {
  en: {
    ...
    loadModelBtn: '📂 Load',
    shareBtn: '🔗 Share',
    exportPngBtn: '🖼️ Export PNG',
    exportCurrentViewTitle: 'Current Canvas View',
    exportCurrentViewSub: 'Active diagram with reactions & internal forces',
    exportUnsolvedTitle: 'Unsolved Problem (Student Exercise)',
    exportUnsolvedSub: 'Clean structure & loads only (for homework/exams)',
    toastPngExported: '🖼️ PNG image exported successfully',
    ...
    autoSplitNodesLabel: 'Auto-create nodes',
    autoSplitNodesTooltip: 'Auto-create nodes and split members when clicking along existing bars',
    toastAutoSplitOn: '⚡ Auto-create nodes on member: ON',
    toastAutoSplitOff: '⚡ Auto-create nodes on member: OFF',
    showNodeLabelsBtn: '📍 Nodes',
    showNodeLabelsTooltip: 'Toggle Node ID labels (N1, N2...)',
    toastNodeLabelsOn: '📍 Node labels: SHOWN',
    toastNodeLabelsOff: '📍 Node labels: HIDDEN',
    showElemLabelsBtn: '🏷️ Members',
    showElemLabelsTooltip: 'Toggle Member ID labels (E1, E2...)',
    toastElemLabelsOn: '🏷️ Member labels: SHOWN',
    toastElemLabelsOff: '🏷️ Member labels: HIDDEN',
    showElemLengthsBtn: '📏 Lengths',
    showElemLengthsTooltip: 'Toggle Member Lengths (4m, 6m...)',
    toastElemLengthsOn: '📏 Member lengths: SHOWN',
    toastElemLengthsOff: '📏 Member lengths: HIDDEN',
    clearCanvasBtn: 'Clear Canvas',
    clearCanvasTooltip: 'Clear canvas and direct to empty frame preset',
    addNodalLoadFloatBtn: 'Add Nodal Load',
    addNodalLoadFloatTooltip: 'Add Nodal Force or Moment (Fx, Fz, M)',
    addDistLoadFloatBtn: 'Add Distributed Load',
    addDistLoadFloatTooltip: 'Add Member Distributed Load (qx, qz)',
    ...
    contactKofiSub: 'Enjoying the ad-free experience? Tip a coffee to keep it running!',
    contactMissionNote: 'Built to keep engineering mechanics free, fast, and 100% ad-free. If this tool saved your coursework or exam prep, consider buying me a coffee to support development!',
    copyBtn: '📋 Copy',
    copiedBtn: '✓ Copied!',
  ...
  pl: {
    ...
    shareBtn: '🔗 Udostępnij',
    exportPngBtn: '🖼️ Eksportuj PNG',
    exportCurrentViewTitle: 'Bieżący widok płótna',
    exportCurrentViewSub: 'Aktywny wykres z reakcjami i siłami wewnętrznymi',
    exportUnsolvedTitle: 'Zadanie do rozwiązania (Dla studentów)',
    exportUnsolvedSub: 'Czysty schemat i obciążenia (na kolokwium/egzamin)',
    toastPngExported: '🖼️ Wyeksportowano obraz PNG',
    ...
    autoSplitNodesLabel: 'Twórz węzły na prętach',
    autoSplitNodesTooltip: 'Automatycznie twórz węzły i dziel pręty po kliknięciu na istniejącym pręcie',
    toastAutoSplitOn: '⚡ Tworzenie węzłów na prętach: WŁ',
    toastAutoSplitOff: '⚡ Tworzenie węzłów na prętach: WYŁ',
    showNodeLabelsBtn: '📍 Węzły',
    showNodeLabelsTooltip: 'Pokaż/Ukryj numery węzłów (N1, N2...)',
    toastNodeLabelsOn: '📍 Numery węzłów: WIDOCZNE',
    toastNodeLabelsOff: '📍 Numery węzłów: UKRYTE',
    showElemLabelsBtn: '🏷️ Pręty',
    showElemLabelsTooltip: 'Pokaż/Ukryj oznaczenia prętów (E1, E2...)',
    toastElemLabelsOn: '🏷️ Oznaczenia prętów: WIDOCZNE',
    toastElemLabelsOff: '🏷️ Oznaczenia prętów: UKRYTE',
    showElemLengthsBtn: '📏 Długości',
    showElemLengthsTooltip: 'Pokaż/Ukryj długości prętów (4m, 6m...)',
    toastElemLengthsOn: '📏 Długości prętów: WIDOCZNE',
    toastElemLengthsOff: '📏 Długości prętów: UKRYTE',
    clearCanvasBtn: 'Wyczyść płótno',
    clearCanvasTooltip: 'Wyczyść płótno i przejdź do pustego schematu',
    addNodalLoadFloatBtn: 'Dodaj siłę węzłową',
    addNodalLoadFloatTooltip: 'Dodaj siłę lub moment w węźle (Fx, Fz, M)',
    addDistLoadFloatBtn: 'Dodaj obciążenie ciągłe',
    addDistLoadFloatTooltip: 'Dodaj obciążenie ciągłe na pręcie (qx, qz)',
    ...
    contactKofiSub: 'Cenisz brak reklam i otwarty dostęp? Postaw kawę i wesprzyj projekt!',
    contactMissionNote: 'Stworzone, by edukacja inżynierska była darmowa, szybka i wolna od reklam. Jeśli ten program ułatwił Ci projekt lub naukę do egzaminu, rozważ postawienie symbolicznej kawy!',
    copyBtn: '📋 Kopiuj',
