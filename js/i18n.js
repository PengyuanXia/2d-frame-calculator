...
export const TRANSLATIONS = {
  en: {
    ...
    showLabelsBtn: '🏷️ Labels',
    showLabelsTooltip: 'Toggle structure text info (Member IDs, Lengths, Node IDs)',
    toastLabelsOn: '🏷️ Structure labels: SHOWN',
    toastLabelsOff: '🏷️ Structure labels: HIDDEN',
  ...
  pl: {
    ...
    showLabelsBtn: '🏷️ Etykiety',
    showLabelsTooltip: 'Pokaż/Ukryj opisy struktury (Numery prętów, długości, węzły)',
    toastLabelsOn: '🏷️ Etykiety struktury: WIDOCZNE',
    toastLabelsOff: '🏷️ Etykiety struktury: UKRYTE',
