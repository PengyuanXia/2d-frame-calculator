...
export class FrameRenderer {
  ...
  drawEmptyState() {
    ...
    ctx.textAlign = 'center';
    ctx.fillText('📐 ' + (this.lang === 'pl' ? 'Pusty schemat ramy — Gotowy do projektowania' : 'Empty Frame — Ready for Design'), this.width / 2, this.height / 2 - 14);
    
    ctx.font = '13px Inter, sans-serif';
    ctx.fillStyle = '#64748b';
    ctx.fillText(this.lang === 'pl' ? 'Kliknij „+ Dodaj węzeł” w panelu bocznym lub wybierz gotowy schemat z „Przykłady”' : 'Click "+ Add Node" on the left panel or select a benchmark preset from "Presets"', this.width / 2, this.height / 2 + 14);
    ctx.restore();
  }
